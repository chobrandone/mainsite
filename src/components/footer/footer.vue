<template >
  <div>
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-3 col-md-6 footer-info">
              <h3 class="image"><img src="../../assets/it_logo.png" alt=""></h3>
              <p>
      ...
      <div class="container">
        <div class="copyright">
          &copy; Copyright <strong>it.next</strong>. All Rights Reserved
        </div>
        <div class="credits">
          <!--
